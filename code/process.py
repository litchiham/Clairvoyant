...
class Process:
    ...
    def __init__(self):
        ...
        self._OUTPUT_DIR_No = os.path.join(config.py_path,'processed')
        self._OUTPUT_DIR_clean_cube = os.path.join(config.py_path,'processed')
        self._OUTPUT_DIR_atm= os.path.join(config.py_path,'processed')
        self._OUTPUT_DIR_rejected = os.path.join(config.py_path,'processed', 'rejected')
    ...
    def import_cubes(self, cube_names:list):
        ...
        for cube_name in cube_names:
            #第一种情况
            cube_folder = os.path.join(config.bin_path, f'ORB{cube_name}_DATA')
    ...
    def _process_cube(self, cube_name):
        try:
            ...
            # 加载OMEGA数据
            cube = cio.cubeio.load(cube_name=cube_name, type='raw')
