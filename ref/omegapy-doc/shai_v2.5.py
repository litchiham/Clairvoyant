import os
os.environ["OMEGA_BIN_PATH"] = r"G:\Omega1"
os.environ["OMEGA_PY_PATH"] = r"G:\Omega1-py" #这个似乎没用
...
# ====== 配置路径 ======
DATA_ROOT = r"G:\Omega1"   # 每个子文件夹都有 .nav/.qub 和 reference_files
DUST_PATH = r"G:\krigedcdod_v2\*.nc"  # 所有 dust nc 文件
OUTPUT_DIR_No = r"G:\Omega1-py\Omega_after_no"    #不需要处理个别像素的文件
OUTPUT_DIR_clean_cube =r"G:\Omega1-py\Omega_after_yes"    #已经经过处理个别像素的文件
OUTPUT_DIR_rejected=r"G:\Omega1-py\Omega_after_rejected"  
OUTPUT_DIR_atm=r"G:\Omega1-py\Omega_after_atm"  
